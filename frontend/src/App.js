  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
        ...
        {/* ── New HMS features ── */}
        <Route path="beds"        element={<ProtectedRoute roles={['admin','doctor','nurse','wardboy']}><BedManagementPage /></ProtectedRoute>}/>
        <Route path="lab-reports" element={<LabReportsPage />}/>
        <Route path="blood-bank"  element={<ProtectedRoute roles={['admin','doctor','nurse','patient']}><BloodBankPage /></ProtectedRoute>}/>
        <Route path="diet"        element={<ProtectedRoute roles={['admin','doctor','nurse','patient']}><DietNutritionPage /></ProtectedRoute>}/>
