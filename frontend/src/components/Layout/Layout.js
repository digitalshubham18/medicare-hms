...
const NAV = {
  admin: [
    ...
    { sec:'Hospital', items:[{id:'pharmacy',icon:'💊',label:'Pharmacy'},{id:'orders',icon:'🛒',label:'Orders'},{id:'records',icon:'📋',label:'Records'},{id:'lab-reports',icon:'🔬',label:'Lab Reports'},{id:'blood-bank',icon:'🩸',label:'Blood Bank'},{id:'diet',icon:'🥗',label:'Diet & Nutrition'},{id:'emergency',icon:'🚨',label:'Emergency',badge:'alerts'}]},
    { sec:'Facility', items:[{id:'rooms',icon:'🏥',label:'Rooms & OT'},{id:'beds',icon:'🛏',label:'Bed Management'},{id:'maintenance-admin',icon:'🔧',label:'Maintenance Hub',badge:'maint'},{id:'chat',icon:'💬',label:'Chat'}]},
  ...
  doctor: [
    ...
    { sec:'Clinical', items:[{id:'records',icon:'📋',label:'Records'},{id:'prescriptions',icon:'📝',label:'Prescriptions'},{id:'lab-reports',icon:'🔬',label:'Lab Reports'},{id:'blood-bank',icon:'🩸',label:'Blood Bank'},{id:'diet',icon:'🥗',label:'Diet & Nutrition'},{id:'emergency',icon:'🚨',label:'Alerts',badge:'alerts'}]},
  ...
  patient: [
    ...
    { sec:'Help', items:[{id:'blood-bank',icon:'🩸',label:'Blood Bank'},{id:'diet',icon:'🥗',label:'My Diet Plan'},{id:'lab-reports',icon:'🔬',label:'Lab Results'},{id:'emergency',icon:'🚨',label:'SOS Emergency'},{id:'symptom-checker',icon:'🤖',label:'AI Checker'},{id:'notice-board',icon:'📢',label:'Notice Board'},{id:'settings',icon:'⚙️',label:'Settings'}]},
  ],
  nurse: [
    ...
    { sec:'Clinical', items:[{id:'lab-reports',icon:'🔬',label:'Lab Reports'},{id:'blood-bank',icon:'🩸',label:'Blood Bank'},{id:'beds',icon:'🛏',label:'Bed Management'},{id:'emergency',icon:'🚨',label:'Alerts'},{id:'reminders',icon:'⏰',label:'Reminders'}]},
